...
namespace GameEngine.PSMR.Dependencies
{
    ...
    public class DependencyException : ApplicationException
    {
        ...
        /// <summary>
        /// The type of the rule that need the dependency (through one of its properties)
        /// </summary>
        public Type DependentRule;

        /// <summary>
        /// The type of the interface defining the dependency contract, for which no implementation was found
        /// </summary>
        ...
        /// <param name="dependentRule">Type of the game rule that requires the dependency</param>
