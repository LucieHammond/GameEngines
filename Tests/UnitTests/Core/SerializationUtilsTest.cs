...
namespace GameEnginesTest.UnitTests.Core
{
    ...
    public class SerializationUtilsTest
    {
        ...
        {
            void write(bool value) => SerializationUtils.WriteBool(m_Data, value, ref m_Cursor);
            bool read() => SerializationUtils.ReadBool(m_Data, ref m_Cursor);
        ...
        {
            void write(byte value) => SerializationUtils.WriteByte(m_Data, value, ref m_Cursor);
            byte read() => SerializationUtils.ReadByte(m_Data, ref m_Cursor);
        ...
        {
            void write(sbyte value) => SerializationUtils.WriteSByte(m_Data, value, ref m_Cursor);
            sbyte read() => SerializationUtils.ReadSByte(m_Data, ref m_Cursor);
        ...
        {
            void write(short value) => SerializationUtils.WriteShort(m_Data, value, ref m_Cursor);
            short read() => SerializationUtils.ReadShort(m_Data, ref m_Cursor);
        ...
        {
            void write(ushort value) => SerializationUtils.WriteUShort(m_Data, value, ref m_Cursor);
            ushort read() => SerializationUtils.ReadUShort(m_Data, ref m_Cursor);
        ...
        {
            void write(int value) => SerializationUtils.WriteInt(m_Data, value, ref m_Cursor);
            int read() => SerializationUtils.ReadInt(m_Data, ref m_Cursor);
        ...
        {
            void write(uint value) => SerializationUtils.WriteUInt(m_Data, value, ref m_Cursor);
            uint read() => SerializationUtils.ReadUInt(m_Data, ref m_Cursor);
        ...
        {
            void write(long value) => SerializationUtils.WriteLong(m_Data, value, ref m_Cursor);
            long read() => SerializationUtils.ReadLong(m_Data, ref m_Cursor);
        ...
        {
            void write(ulong value) => SerializationUtils.WriteULong(m_Data, value, ref m_Cursor);
            ulong read() => SerializationUtils.ReadULong(m_Data, ref m_Cursor);
        ...
        {
            void write(float value) => SerializationUtils.WriteFloat(m_Data, value, ref m_Cursor);
            float read() => SerializationUtils.ReadFloat(m_Data, ref m_Cursor);
        ...
        {
            void write(double value) => SerializationUtils.WriteDouble(m_Data, value, ref m_Cursor);
            double read() => SerializationUtils.ReadDouble(m_Data, ref m_Cursor);
        ...
        {
            void write(char value) => SerializationUtils.WriteChar(m_Data, value, ref m_Cursor);
            char read() => SerializationUtils.ReadChar(m_Data, ref m_Cursor);
        ...
        {
            void write(int value) => SerializationUtils.WriteVarInt(m_Data, value, ref m_Cursor);
            int read() => SerializationUtils.ReadVarInt(m_Data, ref m_Cursor);
        ...
        {
            void write(string value, bool encodeLength) => SerializationUtils.WriteStringAscii(m_Data, value, ref m_Cursor, encodeLength);
            string read(int length) => SerializationUtils.ReadStringAscii(m_Data, ref m_Cursor, length);
            int expectedLength(string value) => value.Length;
        ...
        {
            void write(string value, bool encodeLength) => SerializationUtils.WriteStringUtf8(m_Data, value, ref m_Cursor, encodeLength);
            string read(int length) => SerializationUtils.ReadStringUtf8(m_Data, ref m_Cursor, length);
            int expectedLength(string value) => Encoding.UTF8.GetByteCount(value);
        ...
        {
            void write(byte[] value, bool encodeLength) => SerializationUtils.WriteBuffer(m_Data, value, ref m_Cursor, encodeLength);
            byte[] read(int length) => SerializationUtils.ReadBuffer(m_Data, ref m_Cursor, length);
            int expectedLength(byte[] value) => value.Length;
